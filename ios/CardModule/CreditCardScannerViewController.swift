...
open class CreditCardScannerViewController: UIViewController {
  ...
  public var subtitleLabelText: String = "Giữ yên thẻ để nhận dạng"
  public var cancelButtonTitleText: String = "Thoát"
  ...
  private var delegate: CreditCardScannerViewControllerDelegate?
